...
export default function AlertModal({ title, message, onClose, isOpen }: AlertModalProps) {
    const closeModal = () => {
        onClose()
    }
            ...
            <div className="flex items-center md:items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                >
                    ...
                    <div className="mt-5 sm:mt-6">
                        <button type="button" onClick={closeModal} className="inline-flex justify-center w-full border border-transparent shadow-sm px-4 py-2 bg-black text-base font-bold text-white transition-all hover:bg-gray-200 hover:text-black focus:outline-none focus:ring-none active:outline-none active:ring-none sm:text-md">
                            Ok
                        </button>
                    </div>
                </div>
